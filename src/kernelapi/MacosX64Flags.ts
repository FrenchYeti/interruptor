import {ErrorCodeList} from "../common/Types.js";
import {KernelConstMapping, KernelEnum} from "./Types.js";
...
// copyfile_flags_t
const COPYFILE_FLAGS:KernelEnum = {
    COPYFILE_CHECK: [0],
    COPYFILE_PACK: [0],
    COPYFILE_UNPACK: [0],
    COPYFILE_SECURITY: [0],
