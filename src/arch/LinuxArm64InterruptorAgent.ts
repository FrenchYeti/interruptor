...
const SVC = [
    ...
    [106,"delete_module",0x6a,[A.CONST_NAME.copy("name_user"),"unsigned int flags"]],
    ...
    [182,"mq_timedsend",0xb6,["mqd_t mqdes",A.CONST_NAME.copy("*msg_ptr"),A.SIZE.copy("msg_len"),"unsigned int msg_prio","const struct __kernel_timespec *abs_timeout"]],
    [183,"mq_timedreceive",0xb7,["mqd_t mqdes",A.OUTPUT_CHAR_BUFFER.copy("*msg_ptr"),A.SIZE.copy("msg_len"),"unsigned int *msg_prio","const struct __kernel_timespec *abs_timeout"]],
