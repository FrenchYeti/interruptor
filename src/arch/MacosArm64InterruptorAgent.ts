...
export interface MacosAarch64InterruptorAgentConfig extends InterruptorAgentConfig {
    svc?:any;
    hvc?:any;
    filter_name?:any;
    filter_num?:any;
 ...
 * @class
 */
export class MacosArm64InterruptorAgent extends InterruptorAgent implements IStringIndex {
    ...
    constructor(pConfig:MacosAarch64InterruptorAgentConfig, pDoFollowThread:any, pInterrupts:InterruptSignatureMap) {
