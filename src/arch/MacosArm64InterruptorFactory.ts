...
import {MacosArm64InterruptorAgent, KAPI, MacosAarch64InterruptorAgentConfig} from "./MacosArm64InterruptorAgent.js";
...
export class MacosArm64InterruptorFactory extends AbstractInterruptorFactory {
    ...
    static _followThread(pConfig:any){
        ...
        MacosArm64InterruptorFactory.HOOKED_PTHREAD_ROUTINE = {};
        ...
        Interceptor.attach( addr, {
            onEnter: function(args){
                ...
                depth++;
                if(routine != null && !MacosArm64InterruptorFactory.HOOKED_PTHREAD_ROUTINE.hasOwnProperty(routine)){
                    MacosArm64InterruptorFactory.HOOKED_PTHREAD_ROUTINE[routine+""]=true;
                    ...
                    Interceptor.attach( routine, {
                        onEnter: function(a){
                            ...
                            const b = new MacosArm64InterruptorAgent(cfg, this._followThread,{
                                syscalls: SVC
                            } );
                            MacosArm64InterruptorFactory.AGENTS.push(b);
     ...
     * @param pConfig
     */
    newAgentTracer(pConfig: MacosAarch64InterruptorAgentConfig):InterruptorAgent {

        const agent = new MacosArm64InterruptorAgent(pConfig, MacosArm64InterruptorFactory._followThread, {
            syscalls: SVC
        });
